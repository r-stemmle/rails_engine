...
RSpec.describe "/merchants", type: :request do
  ...
  # Api::V1::MerchantsController, or in your router and rack
  ...
  #              params: { api/v1_merchant: valid_attributes }, headers: valid_headers, as: :json
  ...
  #       expect {
  #         post api_v1_merchants_url,
  #              params: { api/v1_merchant: invalid_attributes }, as: :json
  #       }.to change(Merchant, :count).by(0)
  #     end
  #
  #     it "renders a JSON response with errors for the new api/v1_merchant" do
  #       post api_v1_merchants_url,
  #            params: { api/v1_merchant: invalid_attributes }, headers: valid_headers, as: :json
